...
var dialogs = [
	[
		3,
		0,
		["HELLO COMMANDER", "I AM THE IA OF THIS SHIP", "OUR MISSION", "IS TO RESCUE ALL PASSENGERS.", "SOME INSTRUCTIONS:", "GREEN ARROWS POINT TO PASSENGERS", "RED ARROWS TO ENEMIES", "AND BLUE ARROWS TO JUMP POINTS", "GOOD LUCK!"],
		-1
	],
	[
		2,
