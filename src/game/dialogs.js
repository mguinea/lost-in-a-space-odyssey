...
var dialogs = [
	[
		3.5,
		0,
		["HELLO COMMANDER", "I AM THE IA OF THIS SHIP", "OUR MISSION", "IS TO RESCUE ALL PASSENGERS", "GREEN ARROWS POINTS TO PASSENGERS", "RED ARROWS TO ENEMIES", "AND BLUE ARROWS TO JUMP POINTS"],
		-1
	],
	[
		2,
